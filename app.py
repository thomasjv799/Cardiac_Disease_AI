...
app = Flask(__name__)
client = pymongo.MongoClient("mongodb+srv://thomas123:5799@cardiodb.sz4px.mongodb.net/CardioDB?retryWrites=true&w=majority", ssl=True,
ssl_cert_reqs=ssl.CERT_NONE)
db = client.get_database("Card")
mongo = PyMongo(app)
...
def predict():
    ...
    if (
        ...
        users = user_collection.insert_one(
            {
                "name": datax,
                "age": data1,
                "gender": data2,
